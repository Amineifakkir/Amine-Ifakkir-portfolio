...
export function app(): express.Express {
  ...
  server.get('*', (req, res, next) => {
    ...
    // For Vercel, use https if x-forwarded-proto header is present
    const isHttps = headers['x-forwarded-proto'] === 'https' || protocol === 'https';
    ...
    commonEngine
      .render({
        ...
        url: `${finalProtocol}://${host}${originalUrl}`,
